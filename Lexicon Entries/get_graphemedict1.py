...
def romanize(chn_char, dialect):
    grapheme_mapping = {'a':'A', 'c':'ch', 'j':'dZ', 'q':'QM', 'x':'k s', 'y':'j'}
...
def make_dict(s, dialect):
    ...
    print len(word_list)
    counter = 0
    res_name = dialect + "grapheme_lexicon_entries3.data"
...
#s = read_check_bom("word_list.txt")
