...
sys.argv = [sys.argv[0], r'C:\Zinnia\Carnegie Mellon University\Research\wiki_00']
filename = sys.argv[1]

text = ''.join(codecs.open(filename, 'r', 'utf-8'))
text = re.split('\n', text)
...
# name the file
numpattern = '[0-9][0-9]'
r = re.compile(numpattern)
numstring = r.findall(filename)[0]

name = 'C:\Zinnia\Carnegie Mellon University\Research\wiki_' + numstring + '_sent'

# Write
target = codecs.open(name, 'w', 'utf-8')
for char in res:
    target.write(char)
target.close()
